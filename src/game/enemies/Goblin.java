...
public class Goblin extends Enemy{
    ...
    public Goblin(int playerLevel, EnemyProperty enemyProperty, int basicHealth, int basicAttack, int basicDefence, int basicAvoidChance, int basicCritChance, int expGain) {
        Random rand = new Random();
        this.enemyProperty = enemyProperty;
        int health =  basicHealth + playerLevel * (rand.nextInt(5) + 1);// 20
        this.setName(enemyProperty.name() + " Goblin");
